...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white shadow-md py-4 px-6 flex justify-between items-center">
      ...
      {/* Hamburger Icon */}
      <div className="md:hidden text-gray-600 cursor-pointer mt-4 ml-4 md:mt-0" onClick={() => setMenuOpen(!menuOpen)}>
        <FaBars size={24} />
      </div>
      ...
      >
        {/* Link to Sign page */}
        <Link to="/sign" className="flex items-center space-x-2 px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">
          <FaUser className="text-gray-700" />
          <span>Login/Sign Up</span>
        </Link>

        <Link to="/cart" className="flex items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
